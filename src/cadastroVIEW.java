...
public class cadastroVIEW extends javax.swing.JFrame {
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        mostrarMenssagemNatela(produtodao.cadastrarProduto(produto));
    ...
    private void mostrarMenssagemNatela(boolean e) {

        if (e = false) {

            JOptionPane.showMessageDialog(rootPane, "Tudo ocorreu bem !");
            limparTela();
